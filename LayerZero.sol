...
/**
* @author GetMint
* @title GetMintONFT721
*/
contract GetMintONFT721 is ONFT721, ERC721Enumerable {
    ...
    */
    error GetMintONFT721_CoreError(uint256 errorCode);
    ...
    */
    ...
    ) ONFT721("GetMintONFT", "GTM", _minGasToTransfer, _lzEndpoint) {
    ...
    *
    * @dev emits {GetMintONFT721-MintFeeChanged}
    */
    ...
    *
    * @dev emits {GetMintONFT721-BridgeFeeChanged}
    */
    ...
    *
    * @dev emits {GetMintONFT721-ReferralEarningBipsChanged}
    */
    ...
    *
    * @dev emits {GetMintONFT721-EarningBipsForReferrerChanged}
    */
    ...
    *
    * @dev emits {GetMintONFT721-FeeCollectorChanged}
    */
    ...
    *
    * @dev emits {GetMintONFT721-TokenURIChanged}
    */
    ...
    *
    * @dev emits {GetMintONFT721-TokenURILocked}
    */
    ...
    ************/
    ...
    /**
    * @notice Mint new GetMint ONFT
    *
    * @dev new token ID must be in range [startMintId - maxMintId]
    * @dev tx value must be equal to mintFee. See {GetMintONFT721-mintFee}
    * @dev emits {GetMintONFT721-ONFTMinted}
    */
    ...
    /**
    * @notice Mint new GetMint ONFT by referral
    ...
    * @param _adapterParams relayer adapter parameters
    *
    * @dev emits {GetMintONFT721-BridgeFeeEarned}
    */
    ...
    * @dev emits {GetMintONFT721-FeeEarningsClaimed}
    */
    ...
    *
    * @dev earned amount must be more than zero to claim
    * @dev emits {GetMintONFT721-ReferrerEarningsClaimed}
    */
    ...
    */
    function _validate(bool _clause, uint8 _errorCode) internal pure {
        if (!_clause) revert GetMintONFT721_CoreError(_errorCode);
    }
}
